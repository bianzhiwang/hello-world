...
class BlackjackGame:
    ...
    def __init__(self, players: List[Player]):
        ...
        print("Created a game with {} players.and{}pack of cards".format(len(self.players),num))
    ...
    def deal(self):
        ...
        for _ in range(2):
            for p in self.players:
                ...
                if (str(newcard) == 'Ten of Spades'and str(newcard) == 'Ten of Hearts'
                and str(newcard) == 'Ten of Diamonds' and str(newcard) == 'Ten of Clubs'):
                    newcard = self.deck.draw()
                else:
                    p.hand.append(newcard)
                """ Because deck of spanish blackjack has not rank'ten', so if users
                    get rank '10', redrawed."""
